...
const MarketplaceSection = () => {
  ...
  const allMarketListings = [
    { id: 101, name: "Unit-734", price: "12,500 FROZ", type: "Unit", rarity: "Rare", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680992/item-core_r1ugdp.jpg", seller: "NeonTrader" },
    { id: 102, name: "Void Essence", price: "5,000 FROZ", type: "Material", rarity: "Epic", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-4_znqcaa.jpg", seller: "VoidWalker" },
    { id: 103, name: "Mech-Legs Mk.II", price: "1,200 FROZ", type: "Part", rarity: "Common", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/item-scroll_wztird.jpg", seller: "ScrapLord" },
    { id: 104, name: "Cyber-Eye", price: "800 FROZ", type: "Part", rarity: "Common", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-2_tbujee.jpg", seller: "OpticTech" },
    { id: 105, name: "Data-Scroll", price: "3,300 FROZ", type: "Consumable", rarity: "Rare", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680992/item-eye_recukz.jpg", seller: "CodeMaster" },
    { id: 106, name: "Fusion Core", price: "8,900 FROZ", type: "Material", rarity: "Legendary", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680996/item-legs_ujmc6y.jpg", seller: "CoreDump" },
    { id: 107, name: "Nano-Fiber", price: "150 FROZ", type: "Material", rarity: "Common", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-1_kzcfha.jpg", seller: "Weaver" },
    { id: 108, name: "Titanium Plating", price: "2,400 FROZ", type: "Part", rarity: "Rare", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/item-scroll_wztird.jpg", seller: "Armorer" },
    { id: 109, name: "Energy Cell", price: "50 FROZ", type: "Consumable", rarity: "Common", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680996/item-legs_ujmc6y.jpg", seller: "PowerUp" },
    { id: 110, name: "Quantum Drive", price: "50,000 FROZ", type: "Part", rarity: "Mythic", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-3_twupor.jpg", seller: "StarTraveler" },
    { id: 111, name: "Recruit-Alpha", price: "800 FROZ", type: "Unit", rarity: "Common", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680992/item-cell_g7quo9.jpg", seller: "DraftBoard" },
    { id: 112, name: "Shadow Cloak", price: "6,700 FROZ", type: "Part", rarity: "Epic", image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-1_kzcfha.jpg", seller: "NightOwl" },
  ];
  ...
  const selectedAsset: AssetDetail | null = useMemo(() => {
    ...
    if (selectedSuggestItem != null) {
      return {
        ...
        image: "https://res.cloudinary.com/dit1wd5se/image/upload/v1772680993/nft-mon-4_znqcaa.jpg",
